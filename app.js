...
function menuList(){
  ...
  categoryMenuList.forEach(food => {
    let card = `<div class="col-lg-6 col-xs-12 my-3">
    <div class="row">
      <div class="col-4">
       <img style="height: 170px; border: 0.25rem solid black;
       border-radius: 10px;" class="w-100" src="${food.img}" alt="">
      </div>
      <div class="col-8">
        <div class="d-flex justify-content-between border-bottom border-dark">
          <h4>${food.title}</h4>
          <h4 class="">${food.price}</h4>
        </div>
        <div class="mt-3">
          <p>${food.desc}</p>
        </div>
